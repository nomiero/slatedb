...
The disk cache stays disabled unless `object_store_cache_options.root_folder` is set. If you want it warm before serving traffic, use the cache manager warmup APIs to explicitly warm the SSTs your deployment cares about.
